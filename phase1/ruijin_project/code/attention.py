...
def att_bilstm(inputs, seq_length, hidden_size, scope):
    with tf.variable_scope(scope, reuse=tf.AUTO_REUSE):
        ...
        H2 = inception(inputs=H, num_filters=hidden_size, kernel_size1=1, kernel_size2=3, scope='H2')
        H3 = inception(inputs=H, num_filters=hidden_size, kernel_size1=1, is_onelayers=True, scope='H3')
        # H4 = inception(inputs=H, num_filters=hidden_size, kernel_size1=1, kernel_size2=5, scope='H4')
        H = tf.concat([H, H1, H2, H3], axis=-1)
