    ...
    with open(ann_path, 'r', encoding='utf-8') as f:
        ...
        for line in data:
            ...
            if line.startswith('R'):
                ...
                # print(relation_type)
                # if relation_type.endswith('Disease'):
...
g_path=r'E:\competition\ruijin\phase2\Demo\DataSets\ruijin_round2_test_a\ruijin_round2_test_a\25_1.ann'
p_path1=r'E:\competition\ruijin\phase2\Demo\DataSets\sub\submit_1\25_1.ann'
