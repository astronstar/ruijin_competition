    ...
    with open(path_out, 'w', encoding='utf-8') as fout:
        for path in os.listdir(dir_in):
            if path.endswith('.txt'):
                ...
                # dup
                relations_save, instances_save = get_relations_main(txt_path, ann_path, mv_len=250)
                # all_relations_save.extend(relations_save)
                all_instances_save = {**all_instances_save, **instances_save}
    ...
    with open(path_out, 'w', encoding='utf-8') as fout:
        for path in os.listdir(dir_in):
            if path.endswith('.txt'):
                ...
                all_instances_save = {**all_instances_save, **instances_save}
                # dup
                relations_save, instances_save = get_relations_main(txt_path, ann_path, mv_len=40)
                all_instances_save = {**all_instances_save, **instances_save}
...
def main():
    ...
    if not os.path.exists(r'../DataSets/mydatae'):
        os.makedirs(r'../DataSets/mydatae')
    ...
    if not os.path.exists('../DataSets/mydatae/train_instances.pkl'):
        train_instances_pkl = open('../DataSets/mydatae/train_instances.pkl', 'wb')
        pickle.dump(train_instances, train_instances_pkl)

    if not os.path.exists('../DataSets/mydatae/test_txtid.pkl'):
        test_txtid_pkl = open('../DataSets/mydatae/test_txtid.pkl', 'wb')
        pickle.dump(test_txtid, test_txtid_pkl)

    if not os.path.exists('../DataSets/mydatae/test_instances.pkl'):
        test_instances_pkl = open('../DataSets/mydatae/test_instances.pkl', 'wb')
        pickle.dump(test_instances, test_instances_pkl)

    # if not os.path.exists('../DataSets/mydatae/words_set_b.pkl'):
    #     words_set_pkl = open('../DataSets/mydatae/words_set_b.pkl', 'wb')
    #     pickle.dump(words_set_list, words_set_pkl)

    if not os.path.exists('../DataSets/mydatae/word2id_dic.pkl'):
        word2id_dic_pkl = open('../DataSets/mydatae/word2id_dic.pkl', 'wb')
...
def get_testb():
    ...
    if not os.path.exists('../DataSets/mydatae/testb_txtid.pkl'):
        testb_txtid_pkl = open('../DataSets/mydatae/testb_txtid.pkl', 'wb')
        pickle.dump(testb_txtid, testb_txtid_pkl)

    if not os.path.exists('../DataSets/mydatae/testb_instances.pkl'):
        testb_instances_pkl = open('../DataSets/mydatae/testb_instances.pkl', 'wb')
