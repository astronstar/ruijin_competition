    ...
    with open(path_out, 'w', encoding='utf-8') as fout:
        for path in os.listdir(dir_in):
            if path.endswith('.txt'):
                ...
                # all_relations_save = list(set(all_relations_save))
                # print(len(all_relations_save))
...
def main():
    ...
    path_out_train = r'../DataSets/mydataip/trains.txt'
    path_out_test = r'../DataSets/mydataip/test.txt'
    if not os.path.exists(r'../DataSets/mydataip'):
        os.makedirs(r'../DataSets/mydataip')
    ...
    if not os.path.exists(r'../DataSets/mydataip/train_instances.pkl'):
        train_instances_pkl = open(r'../DataSets/mydataip/train_instances.pkl', 'wb')
        pickle.dump(train_instances, train_instances_pkl)

    if not os.path.exists(r'../DataSets/mydataip/test_txtid.pkl'):
        test_txtid_pkl = open(r'../DataSets/mydataip/test_txtid.pkl', 'wb')
        pickle.dump(test_txtid, test_txtid_pkl)

    if not os.path.exists(r'../DataSets/mydataip/test_instances.pkl'):
        test_instances_pkl = open(r'../DataSets/mydataip/test_instances.pkl', 'wb')
        pickle.dump(test_instances, test_instances_pkl)

    if not os.path.exists(r'../DataSets/mydataip/words_set_b.pkl'):
        words_set_pkl = open(r'../DataSets/mydataip/words_set_b.pkl', 'wb')
...
def get_testb():
    ...
    path_out_testb = r'../DataSets/mydataip/testb.txt'
    testb_txtid, testb_instances = save_relation_results(dir_in_testb, path_out_testb)
    if not os.path.exists(r'../DataSets/mydataip/testb_txtid.pkl'):
        testb_txtid_pkl = open(r'../DataSets/mydataip/testb_txtid.pkl', 'wb')
        pickle.dump(testb_txtid, testb_txtid_pkl)

    if not os.path.exists(r'../DataSets/mydataip/testb_instances.pkl'):
        testb_instances_pkl = open(r'../DataSets/mydataip/testb_instances.pkl', 'wb')
