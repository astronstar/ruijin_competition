...
#     relation_types = ['Relation', 'Other']
    ...
    def __init__(self, max_sequence_length=160):
        if os.path.exists(r'../DataSets/mydataip/train_instances.pkl') and os.path.exists(
                r'../DataSets/mydataip/test_txtid.pkl') and os.path.exists(
            r'../DataSets/mydataip/test_instances.pkl') and os.path.exists(
            r'../DataSets/mydataip/words_set_b.pkl'):
            print('loading pkl...')
            train_instances_pkl = open(r'../DataSets/mydataip/train_instances.pkl', 'rb')
            train_instances = pickle.load(train_instances_pkl)
            test_txtid_pkl = open(r'../DataSets/mydataip/test_txtid.pkl', 'rb')
            test_txtid = pickle.load(test_txtid_pkl)
            test_instances_pkl = open(r'../DataSets/mydataip/test_instances.pkl', 'rb')
            test_instances = pickle.load(test_instances_pkl)
            words_set_pkl = open(r'../DataSets/mydataip/words_set_b.pkl', 'rb')
    ...
    def get_testb_instance(self):
        if os.path.exists(r'../DataSets/mydataip/testb_txtid.pkl') and os.path.exists(
                r'../DataSets/mydataip/testb_instances.pkl'):
            testb_txtid_pkl = open(r'../DataSets/mydataip/testb_txtid.pkl', 'rb')
            testb_txtid = pickle.load(testb_txtid_pkl)
            testb_instances_pkl = open(r'../DataSets/mydataip/testb_instances.pkl', 'rb')
